    ...
    return <form onSubmit={handleSubmit(onSubmit)}>
            <div className="formGroup">
                <div className="formGroupItem">
                    ...
                    {errors.title && <span className="error-text-message">{errors.title.message}</span>}
                </div>
                <div className="formGroupItem">
                ...
                <div className="formGroupItem">
                    ...
                    {errors.status && <span className="error-text-message">{errors.status.message}</span>}
                </div>
                <div className="formGroupItem">
                    ...
                    {errors.priority && <span className="error-text-message">{errors.priority.message}</span>}
                </div>
                <div className="formGroupItem">
                    <label>Дата створення</label>
                    <input {...register('createdAt', { required: true })} type="date" />
                    {errors.createdAt && <span className="error-text-message">{errors.createdAt.message}</span>}
                </div>
                <div className="formGroupItem">
                    <label>Дата виконання</label>
                    <input {...register('deadline', { required: true })} type="date" />
                    {errors.deadline && <span className="error-text-message">{errors.deadline.message}</span>}
                </div>
