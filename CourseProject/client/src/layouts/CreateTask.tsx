...
const CreateTask = ({ open, onOpenChange, onTaskCreated }: CreateTaskProps) => {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting, isValid }, control } = useForm<TaskType>({
      ...
      <SheetContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid flex-1 auto-rows-min gap-6 px-4">
          <div className="grid gap-3">
            ...
            <Input id="title" placeholder="Введіть назву задачі" {...register("title")} />
